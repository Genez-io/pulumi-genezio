...
var functionDocumentation string

func (r *ServerlessFunction) Annotate(a infer.Annotator) {
	a.Describe(&r, functionDocumentation)
}
...
func (r *ServerlessFunctionState) Annotate(a infer.Annotator) {
	a.Describe(&r.ID, `The function ID.`)
	a.Describe(&r.URL, `The URL of the function.`)
}

func (*ServerlessFunction) Diff(ctx context.Context, id string, olds ServerlessFunctionState, news ServerlessFunctionArgs) (p.DiffResponse, error) {
...
func (*ServerlessFunction) Update(ctx context.Context, id string, olds ServerlessFunctionState, news ServerlessFunctionArgs, preview bool) (ServerlessFunctionState, error) {
...
func (*ServerlessFunction) Read(ctx context.Context, id string, inputs ServerlessFunctionArgs, state ServerlessFunctionState) (string, ServerlessFunctionArgs, ServerlessFunctionState, error) {
...
func (*ServerlessFunction) Create(ctx context.Context, name string, input ServerlessFunctionArgs, preview bool) (string, ServerlessFunctionState, error) {
	// TODO Investigate why is this needed - .Sig is used to recognize the asset type when unmarshalling the resource object
	// This should not be hardcoded here, but rather automatically generated by the pulumi SDK
	// Code: https://github.com/pulumi/pulumi/blob/master/sdk/go/common/resource/sig/sig.go
	// Documentation: https://pulumi-developer-docs.readthedocs.io/en/latest/architecture/deployment-schema.html#dabf18193072939515e22adb298388d-required
...
func (*ServerlessFunction) Delete(ctx context.Context, id string, state ServerlessFunctionState) error {
